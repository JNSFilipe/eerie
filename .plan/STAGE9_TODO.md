...
- [x] Reuse Emacs regex search primitives and Eerie's search ring for the new
  search commands
- [x] Add automatic jump recording for registered non-Eerie navigation
  commands
...
- [x] Avoid double-recording Eerie commands that already use explicit jump
  helpers
...
- [x] Add ERT coverage for search commands creating jumplist entries and
  supporting `C-o` / `C-i`
- [x] Add ERT coverage for automatic capture of a non-Eerie navigation command
